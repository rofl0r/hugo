...
#define SCSI_RCV_DIAG   0x1C            /*  Receive Diagnostic Results (0) */
...
typedef struct {
	...
	char    ErrorCode;              /*  Error Code (70H or 71H) */
	char    SegmentNum;             /*  Number of current segment descriptor */
	char    SenseKey;               /*  Sense Key(See bit definitions too) */
	char    InfoByte0;              /*  Information MSB */
	char    InfoByte1;              /*  Information MID */
	char    InfoByte2;              /*  Information MID */
	char    InfoByte3;              /*  Information LSB */
	char    AddSenLen;              /*  Additional Sense Length */
	char    ComSpecInf0;            /*  Command Specific Information MSB */
	char    ComSpecInf1;            /*  Command Specific Information MID */
	char    ComSpecInf2;            /*  Command Specific Information MID */
	char    ComSpecInf3;            /*  Command Specific Information LSB */
	char    AddSenseCode;           /*  Additional Sense Code */
	char    AddSenQual;             /*  Additional Sense Code Qualifier */
/*       char    FieldRepUCode;          // Field Replaceable Unit Code */
/*       char    SenKeySpec15;           // Sense Key Specific 15th byte */
/*       char    SenKeySpec16;           // Sense Key Specific 16th byte */
/*       char    SenKeySpec17;           // Sense Key Specific 17th byte */
/*       char    AddSenseBytes;          // Additional Sense Bytes */
